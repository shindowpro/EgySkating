...
!function(d) {
    ...
    d.zoom = function(o, t, e, n) {
        ...
        return o.style.position = /(absolute|fixed)/.test(s) ? s : "relative",
        o.style.overflow = "hidden",
        e.style.width = e.style.height = "",
        d(e).addClass("zoomImg").css({
            position: "absolute",
            top: 0,
            left: 0,
            opacity: 0,
    ...
    d.fn.zoom = function(e) {
        return this.each(function() {
            ...
            if (!i.url) {
                ...
                if (t && (i.url = t.getAttribute("data-src") || t.currentSrc || t.src,
            ...
            c.onload = function() {
                ...
                function e(o) {
                    t.init(),
                    t.move(o),
                    r.stop().fadeTo(d.support.opacity ? i.duration : 0, 1, "function" == typeof i.onZoomIn && i.onZoomIn.call(c))
                }
                function n() {
                ...
                "grab" === i.on ? a.on("mousedown.zoom", function(o) {
                    ...
                    m ? n() : e(o),
                    m = !m
                }) : "mouseover" === i.on && (t.init(),
                a.on("mouseenter.zoom", e).on("mouseleave.zoom", n).on(l, t.move)),
                i.touch && a.on("touchstart.zoom", function(o) {
                    o.preventDefault(),
                    f ? (f = !1,
                    n()) : (f = !0,
                    e(o.originalEvent.touches[0] || o.originalEvent.changedTouches[0]))
