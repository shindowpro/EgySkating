...
!function(n, r) {
    ...
    tn.VERSION = n,
    tn.prototype.valueOf = tn.prototype.toJSON = tn.prototype.value = function() {
    ...
    function on(n, r, t, e) {
        ...
        return ("function" == u || "object" == u || "object" == typeof r) && function n(r, t, e, u) {
            ...
            if (!o) {
                ...
                i = r.constructor,
                f = t.constructor;
                if (i !== f && !(D(i) && i instanceof i && D(f) && f instanceof f) && "constructor"in r && "constructor"in t)
                    return !1
            }
            e = e || [];
            u = u || [];
    ...
    function hr(i, o, f) {
        return function(n, r, t) {
            ...
            if (r != r)
                return 0 <= (t = o(a.call(n, e, u), $)) ? t + e : -1;
    ...
    function dr(n, r, t) {
        ...
        tr(n))
            ...
            for (var e = nn(n), u = 0, i = e.length; u < i; u++)
                r(n[e[u]], e[u], n);
        return n
    }
    function gr(n, r, t) {
    ...
    function Sr(n, r, t) {
        if (null == r || t)
            return (n = !tr(n) ? mn(n) : n)[Un(n.length - 1)];
        var e = (tr(n) ? Mn : mn)(n)
          , n = Y(e);
    ...
    var Br = j(function(n, r) {
      ...
      , pn = j(function(n, t) {
        var r, e = t[0];
        return D(e) ? (e = fr(e),
        1 < t.length && (r = t[1])) : (t = gr(er(t, !1, !1), String),
        e = function(n, r) {
            return !wr(t, r)
        }
        ),
    ...
    function Dr(n, r, t, e) {
        ...
        for (var u = [], i = [], o = 0, f = Y(n); o < f; o++) {
            var a = n[o]
              , c = t ? t(a, o, n) : a;
            r && !t ? (o && i === c || u.push(a),
            i = c) : t ? wr(i, c) || (i.push(c),
            u.push(a)) : wr(u, a) || u.push(a)
        }
        return u
    }
    vn = j(function(n) {
    ...
    Ln = Vr({
        ...
        template: function(i, n, r) {
            ...
            var t, r = RegExp([(n.escape || Jn).source, (n.interpolate || Jn).source, (n.evaluate || Jn).source].join("|") + "|$", "g"), o = 0, f = "__p+='";
            if (i.replace(r, function(n, r, t, e, u) {
                return f += i.slice(o, u).replace(Hn, Qn),
                o = u + n.length,
        ...
        memoize: function(e, u) {
            function i(n) {
                ...
                return W(r, t) || (r[t] = e.apply(this, arguments)),
                r[t]
            }
            return i.cache = {},
            i
        ...
        throttle: function(t, e, u) {
            ...
            function n() {
                ...
                c = n,
                a = t.apply(o, f),
                i || (o = f = null)) : i || !1 === u.trailing || (i = setTimeout(l, r)),
                a
            }
            return u = u || {},
            n.cancel = function() {
