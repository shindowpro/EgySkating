!function($, c, i, n) {
    ...
    t.prototype.onFindVariation = function(t, a) {
        ...
        (a = i.findMatchingVariations(i.variationData, a).shift()) ? i.$form.trigger("found_variation", [a]) : (i.$form.trigger("reset_data"),
        e.chosenCount = 0,
        i.loading || (i.$form.find(".single_variation").after('<p class="wc-no-matching-variations woocommerce-info">' + wc_add_to_cart_variation_params.i18n_no_matching_variations_text + "</p>"),
    ...
    t.prototype.onFoundVariation = function(t, a) {
        ...
        a.dimensions ? o.wc_set_content($.parseHTML(a.dimensions_html)[0].data) : o.wc_reset_content(),
        i.$form.wc_variations_image_update(a),
        a.variation_is_visible ? (c = _("variation-template"),
        a.variation_id) : c = _("unavailable-variation-template"),
        t = (t = (t = c({
            variation: a
        ...
        n.hide()) : (c = n.find("input.qty"),
        t = parseFloat(c.val()),
        t = isNaN(t) || (t = t > parseFloat(a.max_qty) ? a.max_qty : t) < parseFloat(a.min_qty) ? a.min_qty : t,
        c.attr("min", a.min_qty).attr("max", a.max_qty).val(t).trigger("change"),
        n.show()),
    ...
    t.prototype.onUpdateAttributes = function(t) {
        ...
        w.useAjax || (w.$attributeFields.each(function(t, a) {
            var i = $(a)
              ...
              , n = i.val() || ""
              , s = !0;
            i.data("attribute_html") || ((c = i.clone()).find("option").removeAttr("attached").prop("disabled", !1).prop("selected", !1),
                    ...
                    for (m in l)
                        if (l.hasOwnProperty(m)) {
                            var v = l[m]
                              , g = "";
                            if (m === e)
                                if (d[_].variation_is_active && (g = "enabled"),
                                v) {
                                    ...
                                    o.find("option:gt(0)").addClass("attached " + g)
                        }
                }
            c = o.find("option.attached").length,
            n && (s = !1,
            0 !== c && o.find("option.attached.enabled").each(function() {
                var t = $(this).val();
                if (n === t)
                    return !(s = !0)
            })),
            0 < c && n && s && "no" === r && (o.find("option:first").remove(),
            a = ""),
