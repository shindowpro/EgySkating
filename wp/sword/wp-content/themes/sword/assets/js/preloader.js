!function(t, n) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define(n) : ((t = "undefined" != typeof globalThis ? globalThis : t || self).__SVGATOR_PLAYER__ = t.__SVGATOR_PLAYER__ || {},
    ...
    function A() {
        ...
        return t < 0 || t > 1 || r < 0 || r > 1 ? null : p(t, n) && p(r, e) ? b : function(i) {
            ...
            if (i >= 1)
                return r < 1 ? 1 + (i - 1) * (e - 1) / (r - 1) : 1 === r && t < 1 ? 1 + (i - 1) * (n - 1) / (t - 1) : 1;
      ...
      , N = function() {
        ...
        return o(t, [{
            ...
            value: function() {
                ...
                a /= l;
                var f = 0;
                return i[1][1] < 0 ? (f = j(i[1][1]) * R,
                i[0][1] < 0 && (f = 360 - f)) : f = M(i[0][1]) * R,
                u && (f = -f),
    ...
    function Z(t, n, r) {
        var e = arguments.length > 3 && void 0 !== arguments[3] && arguments[3]
          , i = n.length - 1;
        if (t <= n[0].t)
            return e ? [0, 0, n[0].v] : n[0].v;
        if (t >= n[i].t)
            return e ? [i, 1, n[i].v] : n[i].v;
        var o, u = n[0], a = null;
        for (o = 1; o <= i; o++) {
            if (!(t > n[o].t)) {
                a = n[o];
        ...
        return null == a ? e ? [i, 1, n[i].v] : n[i].v : u.t === a.t ? e ? [o, 1, a.v] : a.v : (t = (t - u.t) / (a.t - u.t),
        u.e && (t = u.e(t)),
    ...
    function X(t, n, e, i, o) {
        var u, a = "@" === e[0], l = "#" === e[0], f = Y[e], s = T;
        switch (a ? (u = e.substr(1),
        e = u.replace(U, Q)) : l && (e = e.substr(1)),
        r(f)) {
        case "function":
            if (s = f(i, o, Z, J, e, a, n, t),
            l)
                return s;
            break;
        case "string":
    ...
    function ut(t, n, r) {
        if (t && t.length) {
            var e = et(r)
              ...
              , o = ot(e) + 5
              , u = it(t, ot(e, 5), o);
            return u = u.replace(/\x7c$/g, "==").replace(/\x2f$/g, "="),
            u = function(t, n, r) {
    ...
    var at = function() {
        ...
        return o(t, [{
            ...
            value: function() {
                ...
                this._rollingBack || (this._rollingBack = !0,
                this._running = !0);
                ...
                var t = this
                  ...
                  , o = function o(u) {
                    ...
                    if (a > r + l && !t._rollingBack) {
                        t.offset = a,
                        r = a;
                        for (var f = t._animations, s = f.length, c = 0, h = 0; h < s; h++)
                            i[h] ? c++ : (i[h] = f[h](a, t.direction),
                            i[h] && c++);
                        if (c === s)
                            return void t._stop()
                    }
            ...
            key: "play",
            value: function() {
                !this._rollingBack && this._running || (this._rollingBack = !1,
                this.rollbackStartOffset > this.duration && (this.offset = this.rollbackStartOffset - (this.rollbackStartOffset - this.offset) % this.duration,
                this.rollbackStartOffset = 0),
            ...
            key: "build",
            value: function(r, e) {
                return delete r.animationSettings,
                ...
                (r = function(t, n) {
                    if (Y = n,
                    !t || !t.root || !Array.isArray(t.animations))
                        return null;
    ...
    function st(t) {
        ...
        if (null == t.a || t.a >= 1) {
            var n = function(t) {
              ...
              , i = n(t.g)
              , o = n(t.b);
            return r(e) && r(i) && r(o) && (e = e.charAt(0),
            i = i.charAt(0),
            o = o.charAt(0)),
            "#" + e + i + o
        }
    ...
    var ht = {
        ...
        u: function(t, n) {
            return function(r) {
                var e = n(r);
                t.setAttribute("rx", lt(e.x)),
                t.setAttribute("ry", lt(e.y))
            }
        }
    }
      , vt = {
    ...
    function dt(t) {
        var n = function() {
            if (gt)
                return gt;
            if ("object" !== ("undefined" == typeof document ? "undefined" : r(document)) || !document.createElementNS)
                return {};
            var t = document.createElementNS("http://www.w3.org/2000/svg", "svg");
            return t && t.style ? (t.style.position = "absolute",
    ...
    function It(t, n, r) {
        ...
        if (Ft(n)) {
            if (Nt(r))
                return _t(n, r.start, r, t, e)
        } else if (Ft(r)) {
            if (n.end)
                return _t(n, n.end, r, t, e)
        } else {
            if (n.end)
                return r.start ? Pt(n, n.end, r.start, r, t, e) : _t(n, n.end, r, t, e);
            if (r.start)
                return _t(n, r.start, r, t, e)
        }
        return At(n, r, t, e)
    ...
    function Dt(t, n, e, i, o, u, a, l) {
        ...
        n = function(t, n, r) {
            for (var e, i, o, u = t.length - 1, a = {}, l = 0; l <= u; l++)
                (e = t[l]).e && (e.e = n(e.e)),
                e.v && "g" === (i = e.v).t && i.r && (o = r.getElementById(i.r)) && (a[i.r] = {
                    e: o,
            ...
            if ("g" === o.t) {
                ...
                Object.keys(Ct).forEach((function(t) {
                    if (void 0 !== o[t])
                        if ("object" !== r(Ct[t])) {
                            var n, e = "gt" === t ? (n = o[t],
                            Array.isArray(n) ? "matrix(" + n.join(" ") + ")" : "") : o[t], i = Ct[t];
    ...
    function zt(t, r, e) {
        ...
        if (r && e) {
            ...
            if (i === e.t)
                ...
                case "g":
                    if (r.r === e.r) {
                        ...
                        r.c ? (o.c = C(t, r.c, e.c),
                        o.rd = q(t, r.rd, e.rd)) : r.f && (o.f = C(t, r.f, e.f),
                        o.to = C(t, r.to, e.to)),
                        o
                    }
                }
            if ("c" === r.t && "g" === e.t || "c" === e.t && "g" === r.t) {
                ...
                return a.s = "c" === r.t ? Vt(t, l, a.s) : Vt(t, a.s, l),
                a
            }
        }
        return T(t, r, e)
