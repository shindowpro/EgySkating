...
!function(e, t) {
    ...
    "use strict";
    return function(o, s) {
        var n, a, l, r, t, i, u, c, p, e, d, m, f, h, w, g, b, v, _ = this, C = !1, T = !0, I = !0, E = {
            barsSize: {
                top: 44,
                bottom: "auto"
            },
            ...
            if (g)
                return !0;
            e = e || window.event,
            w.timeToIdle && w.mouseUsed && !p && y();
            for (var t, n, o = (e.target || e.srcElement).getAttribute("class") || "", l = 0; l < A.length; l++)
                (t = A[l]).onTap && -1 < o.indexOf("pswp__" + t.name) && (t.onTap(),
                n = !0);
            n && (e.stopPropagation && e.stopPropagation(),
            g = !0,
            ...
            e !== h && (x(a, "ui--one-slide", e),
            h = e)
        }, k = function() {
            x(u, "share-modal--hidden", I)
        }, K = function() {
            return (I = !I) ? (s.removeClass(u, "pswp__share-modal--fade-in"),
            setTimeout(function() {
                I && k()
            }, 300)) : (k(),
            setTimeout(function() {
            ...
            I || function() {
                ...
                u.children[0].innerHTML = e,
                u.children[0].onclick = L
            }(),
            !1
        }, L = function(e) {
            var t = (e = e || window.event).target || e.srcElement;
            return o.shout("shareLinkClick", e, t),
            ...
            for (var t = 0; t < w.closeElClasses.length; t++)
                if (s.hasClass(e, "pswp__" + w.closeElClasses[t]))
                    return !0
        }, R = 0, y = function() {
            clearTimeout(v),
            R = 0,
            ...
            e && "HTML" !== e.nodeName || (clearTimeout(v),
            v = setTimeout(function() {
                _.setIdle(!0)
            }, w.timeToIdleOutside))
        }, M = function(e) {
            m !== e && (x(d, "preloader--active", !e),
            m = e)
        }, D = function(e) {
            var t, n = e.vGap;
            !o.likelyTouchDevice || w.mouseUsed || screen.width > w.fitControlsWidth ? (t = w.barsSize,
            w.captionEl && "auto" === t.bottom ? (r || ((r = s.createEl("pswp__caption pswp__caption--fake")).appendChild(s.createEl("pswp__caption__center")),
            a.insertBefore(r, l),
            s.addClass(a, "pswp__ui--fit")),
            w.addCaptionHTMLFn(e, r, !0) ? (e = r.clientHeight,
            n.bottom = parseInt(e, 10) || 44) : n.bottom = t.top) : n.bottom = "auto" === t.bottom ? 0 : t.bottom,
            n.top = t.top) : n.top = n.bottom = 0
        }, A = [{
            name: "caption",
            option: "captionEl",
            onInit: function(e) {
        ...
        _.init = function() {
            ...
            e("onPinchClose", function(e) {
                T && e < .9 ? (_.hideControls(),
                t = !0) : t && !T && .9 < e && _.showControls()
            }),
            ...
            e("bindEvents", function() {
                ...
                o.likelyTouchDevice || s.bind(o.scrollWrap, "mouseover", _.onMouseOver)
            }),
            e("unbindEvents", function() {
                ...
                n && (s.unbind(document, n.eventK, _.updateFullscreen),
                n.isFullscreen() && (w.hideAnimationDuration = 0,
                n.exit()),
                n = null)
            }),
            e("destroy", function() {
                w.captionEl && (r && a.removeChild(r),
                s.removeClass(l, "pswp__caption--empty")),
                    ...
                    if (e)
                        for (var t = e.length, n = 0; n < t; n++) {
                            ...
                            for (var o = 0; o < A.length; o++)
                                i = A[o],
                                -1 < r.indexOf("pswp__" + i.name) && (w[i.option] ? (s.removeClass(l, "pswp__element--disabled"),
                                i.onInit && i.onInit(l)) : s.addClass(l, "pswp__element--disabled"))
                        }
                };
                e(a.children);
            ...
            w.shareEl && i && u && (I = !0),
            S(),
            w.timeToIdle && e("mouseUsed", function() {
            ...
            w.fullscreenEl && !s.features.isOldAndroid && ((n = n || _.getFullscreenAPI()) ? (s.bind(document, n.eventK, _.updateFullscreen),
            _.updateFullscreen(),
            s.addClass(o.template, "pswp--supports-fs")) : s.removeClass(o.template, "pswp--supports-fs")),
            w.preloaderEl && (M(!0),
        ...
        ,
        _.update = function() {
            C = !(!T || !o.currItem) && (_.updateIndexIndicator(),
            w.captionEl && (w.addCaptionHTMLFn(o.currItem, l),
        ...
        _.updateFullscreen = function(e) {
            ...
            s[(n.isFullscreen() ? "add" : "remove") + "Class"](o.template, "pswp--fs")
        }
        ,
        ...
        _.onGlobalTap = function(e) {
            var t = (e = e || window.event).target || e.srcElement;
            g || (e.detail && "mouse" === e.detail.pointerType ? O(t) ? o.close() : s.hasClass(t, "pswp__img") && (1 === o.getZoomLevel() && o.getZoomLevel() <= o.currItem.fitRatio ? w.clickToCloseNonZoomable && o.close() : o.toggleDesktopZoom(e.detail.releasePoint)) : (w.tapToToggleControls && (T ? _.hideControls() : _.showControls()),
            w.tapToClose && (s.hasClass(t, "pswp__img") || O(t)) && o.close()))
        }
        ,
        ...
        _.showControls = function() {
            T = !0,
            C || _.update(),
            s.removeClass(a, "pswp__ui--hidden")
        }
        ,
