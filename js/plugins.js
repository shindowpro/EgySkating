...
$(!document).ready((function () {
    ...
    // Toggling the bootstrap file href link {rtl || ltr} -> [Need Revision]: 
        var langAr = $('.langAr'),
            langEn = $('.langEn'),
            // langArCss = $('link[href="css/bootstrap_rtl.min.css"]'),
            langCss = $('link[href*="bootstrap"]');
        
        langAr.click(function () {
            // console.log($(this).attr("data-value"));
            // $('link[href*="theme"]').attr('href', $(this).attr('data-value'));
            // langCss.attr('href', 'css/bootstrap_rtl.min.css');
            // langEnCss.attr('href' , ).toggle();
            langCss.attr('href').text().replace("css/bootstrap.min.css", "css/bootstrap_rtl.min.css");
        ...
        langEn.click(function () {
            ...
            // langCss.attr('href', 'css/bootstrap_rtl.min.css');
            // langArCss.remove();
            langCss.attr('href').text().replace("css/bootstrap_rtl.min.css", "css/bootstrap.min.css");
        });
// --------------------------------------------------
